...
// let signature1 = await web1337.buildPartialSignatureWithTxData(subchain,privateKey1,aggregatePubKeyOfThreeFriends,arrayOfAfkSigners,nonce,fee,recipient,amountInKLY);

// let signature2 = await web1337.buildPartialSignatureWithTxData(subchain,privateKey2,aggregatePubKeyOfThreeFriends,arrayOfAfkSigners,nonce,fee,recipient,amountInKLY);

// let signature3 = await web1337.buildPartialSignatureWithTxData(subchain,privateKey3,aggregatePubKeyOfThreeFriends,arrayOfAfkSigners,nonce,fee,recipient,amountInKLY);
